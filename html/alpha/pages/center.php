      ...
      <div class="container">
        <ul class="u-list-inline">
          ...
          <li class="list-inline-item g-color-primary">
            <span>WIOA Location Information</span>
          </li>
        </ul>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 g-mb-50 g-mb-0--lg">
            ...
            <div class="u-block-hover g-pos-rel">
              <figure>
                <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="../../assets/img/ataz/apache.jpg" alt="Image Description">
              </figure>
              ...
              <span class="g-pos-abs g-top-20 g-left-0">
                <a class="btn btn-sm u-btn-primary rounded-0 g-color-black" href="#!"><b>Apache Junction</b></a>
                <small class="d-block g-bg-black g-color-white g-pa-5">Pinal County</small>
              </span>
              <!-- End User Info -->
            </div>
            <!-- User Image -->
            ...
            <div class="list-group list-group-border-0 g-mb-40">
              ...
              <a href="page-profile-main-1.html" class="list-group-item list-group-item-action justify-content-between">
                <span>
                  <i class="icon-home g-pos-rel g-top-1 g-mr-8"></i> 11518 E. Apache Trail, Suites 100-111 Apache Junction, Arizona 85220
Pinal County</span>
              </a>
              <!-- End Overall -->
              ...
              <a href="page-profile-profile-1.html" class="list-group-item list-group-item-action justify-content-between active">
                <span>
                  <i class="icon-phone g-pos-rel g-top-1 g-mr-8"></i>(480) 983-0427</span>
              </a>
              <!-- End Profile -->
              ...
              <a href="page-profile-projects-1.html" class="list-group-item list-group-item-action justify-content-between">
                <span>
                  <i class="icon-phone g-pos-rel g-top-1 g-mr-8"></i> TTY: (602) 340-7771</span>
              </a>
              <!-- End My Projects -->
              ...
              <a href="page-profile-comments-1.html" class="list-group-item list-group-item-action justify-content-between">
                ...
                <span class="u-label g-font-size-11 g-bg-pink g-rounded-20 g-px-8">N/A</span>
              </a>
              <!-- End Comments -->
              ...
              <a href="page-profile-reviews-1.html" class="list-group-item list-group-item-action justify-content-between">
                <span>
                  <i class="icon-heart g-pos-rel g-top-1 g-mr-8"></i> Reviews</span>
              </a>
              <!-- End Reviews -->
          ...
          <div class="col-lg-9">
            ...
            <ul class="nav nav-justified u-nav-v1-1 u-nav-primary g-brd-bottom--md g-brd-bottom-2 g-brd-primary g-mb-20" role="tablist"
              ...
              <li class="nav-item">
                <a class="nav-link g-py-10 active" data-toggle="tab" href="#nav-1-1-default-hor-left-underline--1" role="tab">Location Details</a>
              </li>
              <li class="nav-item">
                <a class="nav-link g-py-10" data-toggle="tab" href="#nav-1-1-default-hor-left-underline--2" role="tab">ADA Accomodations</a>
              </li>
            ...
            <div id="nav-1-1-default-hor-left-underline" class="tab-content">
              ...
              <div class="tab-pane fade show active" id="nav-1-1-default-hor-left-underline--1" role="tabpanel" data-parent="#nav-1-1-default-hor-left-underline">
                <h2 class="h4 g-font-weight-300">Apache Junction RSA Resource Room</h2>
                ...
                <ul class="list-unstyled g-mb-30">
                  ...
                  <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">Supervisor Name</strong>
                      <span class="align-top">Deborah Osborn</span>
                    </div>
                    <span>
                  ...
                  <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">Supervisor email address</strong>
                      <span class="align-top">john.doe@something.gov</span>
                    </div>
                    <span>
                      <i class="icon-pencil g-color-gray-dark-v5 g-color-primary--hover g-cursor-pointer g-pos-rel g-top-1"></i>
                    </span>
                  ...
                  <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">Supervisor Phone</strong>
                      <span class="align-top">555-555-5555</span>
                    </div>
                    <span>
                      <i class="icon-pencil g-color-gray-dark-v5 g-color-primary--hover g-cursor-pointer g-pos-rel g-top-1"></i>
                    </span>
                  ...
                  <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">Accessibility Contact</strong>
                      <span class="align-top">Deborah Osborn</span>
                    </div>
                    <span>
                      <i class="icon-pencil g-color-gray-dark-v5 g-color-primary--hover g-cursor-pointer g-pos-rel g-top-1"></i>
                  ...
                  <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">Accessibility Contact email address</strong>
                      <span class="align-top">john.doe@something.gov</span>
                    </div>
                    <span>
                      <i class="icon-pencil g-color-gray-dark-v5 g-color-primary--hover g-cursor-pointer g-pos-rel g-top-1"></i>
                  ...
                  <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">Accessibility Contact Phone</strong>
                      <span class="align-top">555-555-5555</span>
                    </div>
                    <span>
                      <i class="icon-pencil g-color-gray-dark-v5 g-color-primary--hover g-cursor-pointer g-pos-rel g-top-1"></i>
                  ...
                  <!-- End Linked Account -->
                   ...
                   <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">VR Counselor</strong>
                      <span class="align-top">Deborah Osborn</span>
                    </div>
                    <span>
                      <i class="icon-pencil g-color-gray-dark-v5 g-color-primary--hover g-cursor-pointer g-pos-rel g-top-1"></i>
                  ...
                  <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">VR Counselor email address</strong>
                      <span class="align-top">john.doe@something.gov</span>
                    </div>
                    <span>
                      <i class="icon-pencil g-color-gray-dark-v5 g-color-primary--hover g-cursor-pointer g-pos-rel g-top-1"></i>
                  ...
                  <li class="d-flex align-items-center justify-content-between g-brd-bottom g-brd-gray-light-v4 g-py-15">
                    <div class="g-pr-10">
                      <strong class="d-block d-md-inline-block g-color-gray-dark-v2 g-width-200 g-pr-10">VR Counselor Phone</strong>
                      <span class="align-top">555-555-5555</span>
                    </div>
                    <span>
                      <i class="icon-pencil g-color-gray-dark-v5 g-color-primary--hover g-cursor-pointer g-pos-rel g-top-1"></i>
              ...
              <div class="tab-pane fade" id="nav-1-1-default-hor-left-underline--2" role="tabpanel" data-parent="#nav-1-1-default-hor-left-underline">
                <h2 class="h4 g-font-weight-300">View the Assistive Technology available at this location</h2>
                ...
                <div class="shortcode-html">
                    <div id="accordion-04" class="u-accordion" role="tablist" aria-multiselectable="true" >
                      ...
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-04-heading-01" class="u-accordion__header" role="tab" style="background-color:yellow;">
                          <h5 class="mb-0 g-font-weight-300">
                            <a class="d-flex u-link-v5 g-color-main g-color-primary--hover g-font-size-16" href="#accordion-04-body-01" data-toggle="collapse" data-parent="#accordion-04" aria-expanded="false" aria-controls="accordion-04-body-01">
                        ...
                        <div id="accordion-04-body-01" class="collapse" role="tabpanel" aria-labelledby="accordion-04-heading-01" data-parent="#accordion-04">
                          <div class="u-accordion__body g-brd-top g-brd-gray-light-v4 g-color-gray-dark-v5">
                            This is where we can add and information that we think may assist the user.
                          </div>
                ...
                <tbody>
                  ...
                  <td>Jaws</td>
                    ...
                    <td>Resource Room</td>
                      ...
                      <!-- Card -->
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-04-heading-02" class="u-accordion__header" role="tab" style="background-color:green;">
                          <h5 class="mb-0 g-font-weight-300">
                            <a class="d-flex collapsed u-link-v5 g-color-white g-color-white--hover g-font-size-16" href="#accordion-04-body-02" data-toggle="collapse" data-parent="#accordion-04" aria-expanded="false" aria-controls="accordion-04-body-02">
                      ...
                      <!-- Card -->
                      <div class="card rounded-0 g-mb-5">
                        <div id="accordion-04-heading-03" class="u-accordion__header" role="tab" style="background-color:pink;">
                          <h5 class="mb-0 g-font-weight-300">
                            <a class="d-flex collapsed u-link-v5 g-color-main g-color-primary--hover g-font-size-16" href="#accordion-04-body-03" data-toggle="collapse" data-parent="#accordion-04" aria-expanded="false" aria-controls="accordion-04-body-03">
                              <i class="et-icon-bargraph g-font-size-default g-mr-10"></i>
                              PHYSICAL
                            </a>
                          </h5>
                        </div>
                        <div id="accordion-04-body-03" class="collapse" role="tabpanel" aria-labelledby="accordion-04-heading-03" data-parent="#accordion-04">
                          <div class="u-accordion__body g-brd-top g-brd-gray-light-v4 g-color-gray-dark-v5">
                            This is where we sit down, grab a cup of coffee and dial in the details. Understanding the task at hand and ironing out the wrinkles is key. Now that we've aligned the details, it's time to get things mapped out and organized. This part is really crucial
                            in keeping the project in line to completion.
                          </div>
                      ...
                      <!-- End Card -->
                       ...
                       <!-- Card -->
                       <div class="card rounded-0 g-mb-5">
                        <div id="accordion-04-heading-04" class="u-accordion__header" role="tab" style="background-color:skyblue;">
                          <h5 class="mb-0 g-font-weight-300">
                            <a class="d-flex collapsed u-link-v5 g-color-main g-color-primary--hover g-font-size-16" href="#accordion-04-body-04" data-toggle="collapse" data-parent="#accordion-04" aria-expanded="false" aria-controls="accordion-04-body-03">
                              <i class="et-icon-bargraph g-font-size-default g-mr-10"></i>
                              LEARNING
                            </a>
                          </h5>
                ...
                <form>
                        ...
                        <div class="g-brd-primary--checked g-bg-primary-opacity-0_2--checked g-brd-around g-brd-gray-light-v2 g-rounded-5">
                          <div class="media g-pa-12">
                            ...
                            <div class="d-flex align-self-center g-width-20 g-ml-15">
                              <div class="u-check-icon-radio-v5 g-pos-rel g-width-20 g-height-20">
                                <i></i>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="row">
                      ...
                      <div class="form-group g-mb-20">
                        ...
                        <div class="input-group g-brd-primary--focus">
                          ...
                          <div class="input-group-append">
                            <span class="input-group-text g-bg-white g-color-gray-light-v1 rounded-0">
                              <i class="icon-user"></i>
                            </span>
                          </div>
                        </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group g-mb-20">
                        ...
                        <div class="input-group g-brd-primary--focus">
                          <input id="inputGroup1_3" class="form-control form-control-md g-brd-right-none rounded-0 g-py-13" type="text" placeholder="XXXX-XXXX-XXXX-XXXX"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <select class="js-custom-select u-select-v1 g-brd-gray-light-v2 g-color-gray-dark-v5 w-100 g-pt-11 g-pb-10" data-placeholder="Month"
              ...
              <div class="tab-pane fade" id="nav-1-1-default-hor-left-underline--4" role="tabpanel" data-parent="#nav-1-1-default-hor-left-underline">
                ...
                <form>
                  ...
                  <div class="form-group">
                    <label class="d-flex align-items-center justify-content-between">
                      <span>Send me email notification when Decadent Desires sends me a message</span>
                      <div class="u-check">
