  ...
  <main>
   ...
   <?php require '../includes/nav.php';?>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
      <!-- Parallax Image -->
      <div class="divimage dzsparallaxer--target w-100 g-bg-cover g-bg-pos-center g-bg-black-opacity-0_5--after" style="height: 140%; background-image: url(../../assets/img/ataz/ability360.jpg);"></div>
      <!-- End Parallax Image -->
      ...
      <div class="container g-color-white text-center g-py-150">
        ...
        <h3 class="h1 text-uppercase mb-0">Using Assistive Technology and Disability Awareness Training to overcome disability barriers.</h3>
      </div>
      <!-- image list-->
      <ul class="row list-inline text-center g-pb-60 mb-0">
        <li class="col" data-animation="fadeIn" data-animation-delay="300" data-animation-duration="500">
          <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/hands_free.jpg" alt="Image Description">
        ...
        <li class="col" data-animation="fadeIn" data-animation-delay="400" data-animation-duration="600">
          <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/apache.jpg" alt="Image Description">
        ...
        <li class="col" data-animation="fadeIn" data-animation-delay="500" data-animation-duration="700">
          <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/anatomy.png" alt="Image Description">
        ...
        <li class="col" data-animation="fadeIn" data-animation-delay="600" data-animation-duration="800">
          <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/lgshow.jpg" alt="Image Description">
        ...
        <li class="col" data-animation="fadeIn" data-animation-delay="700" data-animation-duration="900">
          <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/eye_calibration.jpg" alt="Image Description">
    ...
    <section class="container g-pt-100 g-pb-50">
      <div class="row justify-content-center g-mb-60">
        <div class="col-lg-7">
          ...
          <div class="text-center">
            ...
            <p class="lead mb-5">Assistive Technology (A.T.) includes thousands of products that enable persons with disabilities to be more productive
              and independent in daily activities. Assistive technology products range from simple to complex and can be
              used at home, work, school and in the community to reduce barriers and increase personal abilities.
            </p>
          </div>
          <!-- End Heading -->
        </div>
      ...
      <div class="row">
        <div class="col-lg-6 g-mb-50">
          <img class="img-fluid" src="../../assets/img/ataz/Gilbert_Guadalupe.jpg" alt="Image Description">
        </div>
        <div class="col-lg-6">
          <div class="mb-5">
            <h5>Gilbert Guadalupe RSA Office</h5>
            <p class="g-mb-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
        ...
        <div class="row">
          <div class="col-lg-4 g-py-100 g-px-40--sm">
            ...
            <div class="text-center">
              ...
              <p class="g-color-gray-dark-v4">We strive to embrace and drive change in our industry which allows us to keep our clients relevant and ready
                to adapt.</p>
    ...
    <div class="dzsparallaxer auto-init height-is-based-on-content g-bg-gray-gradient-opacity-v1
      ...
      <div class="container g-pt-100 ">
        ...
        <div class="masonry-grid row mb-5 ">
          ...
          <div class="masonry-grid-item col-lg-6 g-mb-100 ">
            <div class="g-pr-40--lg ">
              <!-- Heading -->
              <span class="d-block g-color-primary g-font-size-17 text-uppercase mb-4 ">Counselor Training Day</span>
              ...
              <p class="lead mb-5 ">Using Assistive Technology and Disability Awareness Training to overcome disability barriers.</p>
              <a class="btn btn-xl u-btn-outline-black g-font-weight-600 g-font-size-default g-px-35 " href="#! ">Sign Up!</a>
              <!-- End Heading -->
            </div>
          </div>
        ...
        ", final:"25 "}]'>
              <img class="img-fluid w-100 " src="../../../html/assets/img/ataz/lgshow.jpg " alt="Image Description ">
            </div>
          </div>
          <div class="masonry-grid-item col-sm-6 col-lg-3 mt-5 g-mb-30 ">
            <div data-parallaxanimation='[{property: "transform ", value:" translate3d(0,px,0) ", initial:"25 ", mid:"0
        ", final:"-25 "}]'>
              <img class="img-fluid w-100 " src="../../../html/assets/img/ataz/hands_free.jpg " alt="Image Description ">
            </div>
          </div>
          <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30 ">
            <div data-parallaxanimation='[{property: "transform ", value:" translate3d(0,px,0) ", initial:"-45 ", mid:"0
        ", final:"45 "}]'>
              <img class="img-fluid w-100 " src="../../../html/assets/img/ataz/CCTV_mirror.jpg" alt=" Image Description ">
            </div>
          </div>
        </div>
        <!-- End Masonry -->
      ...
      <div class="row justify-content-center g-mb-60">
        <div class="col-lg-7">
          ...
          <div class="text-center">
            ...
            <div class="d-inline-block g-width-35 g-height-2 g-bg-primary mb-2"></div>
            <p class="mb-0">We are a creative studio focusing on culture, luxury, editorial &amp; art. Somewhere between sophistication and
              simplicity.
            </p>
          </div>
          <!-- End Heading -->
      ...
      <div class="row">
        <div class="col-lg-3 col-sm-6 g-mb-30">
          <div class="text-center u-block-hover">
            ...
            <figure class="u-block-hover g-mb-25">
              <!-- Figure Image -->
              <img class="w-100 staff-img img-fluid" src="../../../html/assets/img/ataz/staff/Virginia_Thompson.jpg" alt="Image Description">
              <!-- End Figure Image -->
            ...
            <!-- Figure Info -->
            <em class="d-block g-font-style-normal g-font-size-16 text-uppercase g-color-primary g-mb-5">A.T./I.T. Director</em>
        ...
        <div class="col-lg-3 col-sm-6 g-mb-30">
          <div class="text-center u-block-hover">
            ...
            <figure class="u-block-hover g-mb-25">
              <!-- Figure Image -->
              <img class="w-100 staff-img img-fluid" src="../../../html/assets/img/ataz/staff/Angela_Goldenberg.jpg" alt="Image Description">
              <!-- End Figure Image -->
            ...
            <!-- Figure Info -->
            <em class="d-block g-font-style-normal g-font-size-16 text-uppercase g-color-primary g-mb-5">Trainer</em>
        ...
        <div class="col-lg-3 col-sm-6 g-mb-30">
          <div class="text-center u-block-hover">
            ...
            <figure class="u-block-hover g-mb-25">
              <!-- Figure Image -->
              <img class="w-100 staff-img img-fluid" src="../../../html/assets/img/ataz/staff/Kristina_Le.jpg" alt="Image Description">
              <!-- End Figure Image -->
            ...
            <!-- Figure Info -->
            <em class="d-block g-font-style-normal g-font-size-16 text-uppercase g-color-primary g-mb-5">Training Coordinator</em>
        ...
        <div class="col-lg-3 col-sm-6 g-mb-30">
          <div class="text-center u-block-hover">
            ...
            <figure class="u-block-hover g-mb-25">
              <!-- Figure Image -->
              <img class="w-100 staff-img img-fluid" src="../../../html/assets/img/ataz/staff/Jason_R.jpg" alt="Image Description">
              <!-- End Figure Image -->
            ...
            <!-- Figure Info -->
            <em class="d-block g-font-style-normal g-font-size-16 text-uppercase g-color-primary g-mb-5">Web Master</em>
    ...
    <!-- Hero Info -->
    <section class="g-bg-cover g-bg-size-cover g-bg-black-opacity-0_8--after g-py-120 " style="background-image: url(../../../html/assets/img/ataz/Casa_Grande_Florence_Blvd.jpg); ">
      <div class="container text-center g-color-white g-pos-rel g-z-index-1 ">
        <div class="row justify-content-center ">
          <div class="col-md-8 ">
            ...
            <p class="lead g-color-white-opacity-0_8 g-font-weight-400 g-mb-50 ">Resources | Hands-on training | A.T. experts</p>
            <a class="btn btn-xl u-btn-primary g-font-weight-600 g-font-size-default g-px-35 " href="#! ">Learn more</a>
          </div>
        </div>
      </div>
