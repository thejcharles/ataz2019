    ...
    <main>
        ...
        <section
            ...
            <div class="divimage dzsparallaxer--target w-100 g-bg-cover g-bg-pos-center g-bg-black-opacity-0_5--after"
                style="height: 140%; background-image: url(../../assets/img/ataz/ability360.jpg);"></div>
            <!-- End Parallax Image -->
            ...
            <ul class="row list-inline text-center g-pb-60 mb-0">
                <li class="col" data-animation="fadeIn" data-animation-delay="300" data-animation-duration="500">
                    <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/hands_free.jpg"
                ...
                <li class="col" data-animation="fadeIn" data-animation-delay="400" data-animation-duration="600">
                    <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/apache.jpg"
                        alt="Image Description">
                ...
                <li class="col" data-animation="fadeIn" data-animation-delay="500" data-animation-duration="700">
                    <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/anatomy.png"
                        alt="Image Description">
                ...
                <li class="col" data-animation="fadeIn" data-animation-delay="600" data-animation-duration="800">
                    <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/lgshow.jpg"
                        alt="Image Description">
                ...
                <li class="col" data-animation="fadeIn" data-animation-delay="700" data-animation-duration="900">
                    <img class="g-width-100 u-block-hover__main" src="../../../html/assets/img/ataz/eye_calibration.jpg"
                        alt="Image Description">
        ...
        <section class="container g-pt-100 g-pb-50">
            <div class="row justify-content-center g-mb-60">
                ...
                <div align="center">
                    ...
                    <div class="d">
                        <button class="b1">General</button>
                        <button class="b2">Vision</button>
                        <button class="b3">Hearing</button>
                        <button class="b4">Cognition</button>
                        <button class="b5">Physical</button>
                        <button class="b6">Other</button>
                    </div>
                </div>
            </div>
            ...
            <div class="container g-pt-100 ">
                ...
                <div class="masonry-grid row mb-5 ">
                    ...
                    <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30 ">
                        <div
                            data-parallaxanimation='[{property: "transform ", value:" translate3d(0,px,0) ", initial:"-25 ", mid:"0
        ", final:"25 "}]'>
                            <img class="img-fluid w-100 " src="../../../html/assets/img/ataz/lgshow.jpg "
                                alt="Image Description ">
                        </div>
                    </div>
                    <div class="masonry-grid-item col-sm-6 col-lg-3 mt-5 g-mb-30 ">
                        <div
                            data-parallaxanimation='[{property: "transform ", value:" translate3d(0,px,0) ", initial:"25 ", mid:"0
        ", final:"-25 "}]'>
                            <img class="img-fluid w-100 " src="../../../html/assets/img/ataz/hands_free.jpg "
                                alt="Image Description ">
                        </div>
                    </div>
                    <div class="masonry-grid-item col-sm-6 col-lg-3 g-mb-30 ">
                        <div
                            data-parallaxanimation='[{property: "transform ", value:" translate3d(0,px,0) ", initial:"-45 ", mid:"0
        ", final:"45 "}]'>
                            <img class="img-fluid w-100 " src="../../../html/assets/img/ataz/CCTV_mirror.jpg"
                                alt=" Image Description ">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 g-mb-30">
                    <div class="text-center u-block-hover">
                        ...
                        <figure class="u-block-hover g-mb-25">
                            <!-- Figure Image -->
                            <img class="w-100 staff-img img-fluid"
                                src="../../../html/assets/img/ataz/staff/Virginia_Thompson.jpg" alt="Image Description">
                            <!-- End Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-30">
                    <div class="text-center u-block-hover">
                        ...
                        <figure class="u-block-hover g-mb-25">
                            <!-- Figure Image -->
                            <img class="w-100 staff-img img-fluid"
                                src="../../../html/assets/img/ataz/staff/Angela_Goldenberg.jpg" alt="Image Description">
                            <!-- End Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-30">
                    <div class="text-center u-block-hover">
                        ...
                        <figure class="u-block-hover g-mb-25">
                            <!-- Figure Image -->
                            <img class="w-100 staff-img img-fluid"
                                src="../../../html/assets/img/ataz/staff/Kristina_Le.jpg" alt="Image Description">
                            <!-- End Figure Image -->
                ...
                <div class="col-lg-3 col-sm-6 g-mb-30">
                    <div class="text-center u-block-hover">
                        ...
                        <figure class="u-block-hover g-mb-25">
                            <!-- Figure Image -->
                            <img class="w-100 staff-img img-fluid" src="../../../html/assets/img/ataz/staff/Jason_R.jpg"
                                alt="Image Description">
                            <!-- End Figure Image -->
