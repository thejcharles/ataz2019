            ...
            <!-- Location Card -->
              <div class="col-lg-3 col-sm-6 g-mb-30 u-shadow-v1-3">
                ...
                <figure class="g-color-gray-dark-v2">
                  <!-- Figure Image -->
                  <img class="w-100 g-mb-30" src="/img/ataz/onestops/{{$location->photo}}" alt="Image of {{$location->name}}">
                  <!-- End Figure Image -->
      
                  <!-- Figure Info -->
                  <em class="d-block g-font-style-normal g-font-size-11 text-uppercase g-color-primary g-mb-5">{{$location->city}}</em>
