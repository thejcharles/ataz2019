            ...
            <div class="col-lg-9">
              ...
              <div class="shortcode-html">
                ...
                <article class="row mx-0 g-brd-bottom--md g-brd-bottom-2 g-brd-primary">
                  <div class="col-md-6 g-bg-size-cover g-min-height-250" data-bg-img-src="/img/ataz/onestops/{{$location->photo}}"></div>
                  ...
                  <div class="col-md-6 g-bg-secondary g-pa-40">
                    ...
                    <footer class="d-flex justify-content-between">
                      ...
                      <div class="align-self-center">
                        <a class="btn btn-md u-btn-primary g-font-weight-600 g-font-size-default text-uppercase" href="#">Get Directions</a>
                      </div>
                    </footer>
                    <!-- End Article Footer -->
                  </div>
