...
@section('content')
  ...
  <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall " data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
    <!-- Parallax Image -->
    <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-black-opacity-0_4--after" style="height: 140%; background-image: url(/img/ataz/hands_free.jpg);"></div>
    <!-- End Parallax Image -->
  ...
  <section class="container g-pt-100 g-pb-40">
    <div class="row justify-content-between">
      ...
      <div class="col-lg-4 g-mb-60">
        <!-- Google Map -->
        <div id="GMapRoadmap" class="js-g-map embed-responsive embed-responsive-21by9 g-height-300" data-lat="{{getenv('CENTER_LOCATION_LAT')}}" data-lng="{{getenv('CENTER_LOCATION_LONG')}}" data-pin="true"></div>
        ...
        <div class="media mb-2">
          ...
          <div class="media-body">
            <p class="g-color-gray-dark-v3 mb-2">Email: <a class="g-color-gray-dark-v4" href="mailto:info@atarizona.com">info@atarizona.com</a>
            </p>
          </div>
        </div>
        <div class="media mb-2">
