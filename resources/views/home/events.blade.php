...
@section('content')
  ...
  <div class="g-min-height-450 g-flex-centered g-bg-img-hero g-bg-pos-top-center g-bg-size-cover g-pt-80"
       style="background-image: url(/img/acbvi/bball.jpg);">
        ...
        <div class="g-pos-rel">
          ...
          <div class="g-pos-abs g-bottom-minus-30 g-right-0 g-right-minus-20--sm">
            <a class="js-fancybox d-flex g-text-underline--none--hover" href="javascript:;"
              ...
              <span
                class="u-icon-v3 u-icon-size--lg g-color-white g-bg-primary g-bg-main--hover rounded g-pos-rel g-z-index-1 g-cursor-pointer">
        ...
        <div class="g-pl-40--lg">
          <div class="mb-5">
            ...
            <p class="g-line-height-2">
              Join us for our annual "In The Dark" event, hosted by the ACBVI board of directors. This will be a FREE
              experiential movie event for sighted members of the community to experience a movie night without their
              sight. For this special viewing, the movie screen will be blacked out and you will ‘watch’ the show by
              listening to the action with the use of audio description. Our feature film of the evening is Game Night
              (2018) starring Jason Bateman and Rachel McAdams.
            </p>
          </div>
          
          <a
            class="nav-link rounded g-color-white--hover g-bg-transparent g-bg-main--hover g-font-weight-600 g-font-size-15 g-px-14 g-py-10"
        ...
        <div class="g-pos-rel">
          ...
          <div class="g-pos-abs g-bottom-minus-30 g-right-0 g-right-minus-20--sm">
            <a class="js-fancybox d-flex g-text-underline--none--hover" href="javascript:;"
               ...
               data-caption="Video Popup">
              <span
                class="g-color-main g-font-weight-500 g-font-size-13 mt-auto mr-4">Watch ride for reading Video</span>
              <span
                class="u-icon-v3 u-icon-size--lg g-color-white g-bg-primary g-bg-main--hover rounded g-pos-rel g-z-index-1 g-cursor-pointer">
                    <i class="g-font-size-17 g-pos-rel g-left-2 fa fa-play"></i>
                  </span>
      ...
      <div class="col-lg-6 order-lg-1 g-mb-100">
        <div class="g-pr-40--lg">
          <div class="mb-5">
            ...
            <p class="g-line-height-2">
              Come ride to benefit tje Arizona State Braille and Talking Book Library which serves 9,000 visually
              inpaired Arizona residents. Proceeds
              go to support the library, its volunteer programs and local recording studios which provie audio books,
              magazines and newpapers to patrons.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="g-pos-rel">
          ...
          <div class="g-pos-abs g-bottom-minus-30 g-right-0 g-right-minus-20--sm">
            <a class="js-fancybox d-flex g-text-underline--none--hover" href="javascript:;"
               ...
               data-caption="Video Popup">
              <span
                class="g-color-main g-font-weight-500 g-font-size-13 mt-auto mr-4">Watch Building Community Video</span>
              <span
                class="u-icon-v3 u-icon-size--lg g-color-white g-bg-primary g-bg-main--hover rounded g-pos-rel g-z-index-1 g-cursor-pointer">
                    <i class="g-font-size-17 g-pos-rel g-left-2 fa fa-play"></i>
                  </span>
    ...
    <div class="container g-pos-rel g-z-index-1">
      <div class="row justify-content-between">
        <div class="col-md-5 g-py-100">
          ...
          <a
            class="btn u-btn-black g-brd-primary--hover g-color-white g-color-white--hover g-bg-main g-bg-main--hover g-font-weight-600 g-font-size-12 text-uppercase g-px-25 g-py-13"
            href="donate">
            Donate
            <i class="g-pos-rel g-top-minus-1 ml-2 fa fa-angle-right"></i>
          </a>
