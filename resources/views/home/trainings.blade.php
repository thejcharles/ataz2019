        ...
        <div class="g-pl-20--lg">
          ...
          @foreach($trainings as $training)
            <article class="g-mb-100">
              <div class="g-mb-30">
                        <span
                          class="d-block g-color-gray-dark-v4 g-font-weight-700 g-font-size-12 text-uppercase mb-2">{{ date('l F jS, Y', strtotime($training->dates))}}</span>
                <h2 class="h4 g-color-black g-font-weight-600 mb-3">
                  <a class="u-link-v5 g-color-black g-color-primary--hover"
                     href="#!">{{$training->event}}</a>
                </h2>
                <h3>Location: {{ $training->location }} </h3>
              ...
              <ul class="list-inline g-brd-y g-brd-gray-light-v3 g-font-size-13 g-py-13 mb-0">
                <li class="list-inline-item g-color-gray-dark-v4 mr-2">
                            <span class="d-inline-block g-color-gray-dark-v4">
                                <img class="g-g-width-20 g-height-20 rounded-circle mr-2"
                                     src="../../assets/img/ataz/staff/Angela_Goldenberg.jpg" alt="Image Description">
                                {{$training->contact}}
                            </span>
                </li>
                <li class="list-inline-item g-color-gray-dark-v4">
                  <a
                    class="d-inline-block g-color-gray-dark-v4 g-color-white--hover g-bg-gray-dark-v2--hover rounded g-transition-0_3 g-text-underline--none--hover g-px-15 g-py-5"
                    href="#!">
                    <i class="align-middle g-font-size-default mr-1 icon-clock u-line-icon-pro"></i>
                    From {{ date('g:i A', strtotime($training->start))}}
                    -
                ...
                <li class="list-inline-item g-color-gray-dark-v4">
                  <a
                    class="d-inline-block g-color-gray-dark-v4 g-color-white--hover g-bg-gray-dark-v2--hover rounded g-transition-0_3 g-text-underline--none--hover g-px-15 g-py-5"
                    href="emailto:{{$training->contact_email}}"></a>
                ...
                <li>
                  <article class="media g-mb-35">
                    ...
                    <div class="media-body">
                      ...
                      <a class="btn u-btn-outline-primary g-font-size-11 g-rounded-25" href="#!">Get
                        started</a>
                    </div>
                  </article>
                </li>
