...
@section('content')
    ...
    <!-- Promo Banner -->
    <div class="g-min-height-450 g-flex-centered g-bg-img-hero g-bg-pos-top-center g-bg-size-cover g-pt-80" style="background-image: url(img/acbvi/eye_sim_tint.jpg);">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="g-bg-secondary text-center g-pa-20">
                                    <div class="u-shadow-v19 g-width-110 g-height-110 g-brd-around g-brd-5 g-brd-white rounded-circle mx-auto mb-4">
                                        <img class="img-fluid rounded-circle" src="/img/acbvi/board/{{$l->photo}}" alt="Image of {{$l->name}}">
                                    </div>
    ...
    <!-- Promo Banner -->
    <div class="g-bg-img-hero g-bg-pos-top-center g-bg-size-cover g-bg-cover g-bg-white-gradient-opacity-v5--after" style="background-image: url(/img/acbvi/counseling.JPG);">
        <div class="container g-pos-rel g-z-index-1">
