...
@section('content')
  ...
  <div class="container g-pt-20">
    <div class="u-shadow-v34 g-brd-around g-brd-12 g-brd-white rounded g-pos-rel g-z-index-1">
      <div class="g-min-height-70vh g-flex-centered g-bg-img-hero rounded"
           style="background-image: url(img/acbvi/3teach.JPG);">
        <div class="w-100 g-pos-abs g-bottom-0 g-left-0 g-z-index-1">
          <div class="g-bg-white g-pos-rel g-px-30 g-pt-30 g-pt-0--md g-pb-15">
            <h1><a class="h1 u-link-v5 g-color-main g-color-primary--hover g-font-size-45--md" href="#">ACBVI Staff</a>
            </h1>
            <!-- SVG Top Background Shape -->
            <svg class="w-100 g-hidden-sm-down g-pos-abs g-top-minus-80x g-left-0 g-z-index-minus-1" version="1.1"
  ...
  <!-- Call to Action -->
  <div class="u-shadow-v35 g-bg-img-hero u-bg-overlay g-bg-black-opacity-0_5--after"
       style="background-image: url(/img/acbvi/steve_welker_group_picture.jpg); min-height:20rem" ;>
        ...
        <div class="js-slide u-block-hover g-pb-10 g-mx-15">
          <div class="g-overflow-hidden">
            <img class="img-fluid w-100 u-block-hover__main--zoom-v1 g-transition-0_5"
                 src="/img/acbvi/staff/{{$s->photo}}" alt="Image Description">
          </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 g-py-15 g-mb-30">
        <div class="g-px-30--lg">
          ...
          <p class="g-color-text-light-v1 mb-0">In a community that provides endless opportunities for you to make
            impact.</p>
        </div>
      </div>
    </div>
  ...
  <div class="g-pos-rel">
    <div class="container text-center g-pt-100 g-pb-50">
      ...
      <a class="btn u-shadow-v33 g-color-white g-bg-primary g-bg-main--hover g-rounded-30 g-px-35 g-py-13"
         href="careers">View Opportunities</a>
      ...
      <a
        class="btn u-shadow-v32 g-color-primary g-color-white--hover g-bg-white g-bg-main--hover g-rounded-30 g-px-35 g-py-13"
