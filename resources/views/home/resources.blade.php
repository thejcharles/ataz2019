...
@section('content')
  ...
  <div class="row">
    ...
    <!-- Nav tabs -->
    <ul class="nav text-center nav-justified u-nav-v1-1 g-mb-20" role="tablist" data-target="nav-1-1-accordion-default-hor-left-big-icons" data-tabs-mobile-type="accordion" data-btn-classes="btn btn-md btn-block rounded-0 u-btn-outline-lightgray g-mb-20">
      <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#nav-1-1-accordion-default-hor-left-big-icons--1" role="tab">
